...
public abstract class LocalGENASubscription extends GENASubscription<LocalService> implements PropertyChangeListener {
    ...
    private String TAG = "LocalGENASubscription";
...
//        Utils.print(TAG,"Reading initial state of local service at subscription time");
...
//        Utils.print(TAG,"Got evented state variable values: " + values.size());

        for (StateVariableValue value : values) {
            this.currentValues.put(value.getStateVariable().getName(), value);

            if (log.isLoggable(Level.FINEST)) {
//            	Utils.print(TAG,"Read state variable value '" + value.getStateVariable().getName() + "': " + value.toString());
            }
...
//        Utils.print(TAG,"Eventing triggered, getting state for subscription: " + getSubscriptionId());
...
//            	Utils.print(TAG,"Adding state variable value to current values of event: " + 
