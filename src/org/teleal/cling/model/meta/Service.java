...
//        Utils.print("action_type", serviceType.getType());
        if (actions != null) {
            for (Action action : actions) {
                this.actions.put(action.getName(), action);
                
//                Utils.print("action_name", action.getName());
    ...
    public Datatype<S> getDatatype(ActionArgument argument) {
    	//add by andy
    	if(getRelatedStateVariable(argument)!=null){
    		if(getRelatedStateVariable(argument).getTypeDetails()!=null){
    			if(getRelatedStateVariable(argument).getTypeDetails().getDatatype()!=null){
...
//        return getRelatedStateVariable(argument).getTypeDetails().getDatatype();
    ...
    public List<ValidationError> validate() {
        ...
        */
        ...
        if (hasActions()) {
//        	
//shujun: I don't know why it check "hasActions()" here, it can make a exception.
//        Need check it later.
