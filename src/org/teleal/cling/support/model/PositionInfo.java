...
public class PositionInfo {
    ...
    public PositionInfo(Map<String, ActionArgumentValue> args) {
        this(
                ...
                (String) args.get("TrackDuration").getValue()!=null?(String) args.get("TrackDuration").getValue():"00:00:00",
                (String) args.get("TrackMetaData").getValue()!=null?(String) args.get("TrackMetaData").getValue():"NOT_IMPLEMENTED",
                (String) args.get("TrackURI").getValue()!=null?(String) args.get("TrackURI").getValue():"",
                (String) args.get("RelTime").getValue()!=null?(String) args.get("RelTime").getValue():"00:00:00",
                (String) args.get("AbsTime").getValue()!=null?(String) args.get("AbsTime").getValue():"00:00:00",
                (Integer) args.get("RelCount").getValue()!=null?(Integer) args.get("RelCount").getValue():Integer.MAX_VALUE,
                (Integer) args.get("AbsCount").getValue()!=null?(Integer) args.get("AbsCount").getValue():Integer.MAX_VALUE
        );
    }
