 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(org.teleal.cling.support.model.DescMeta, org.seamless.xml.SAXParser.Handler)}
 ...
 * </p>
 * <p>
 * Override the {@link #createItemHandler(org.teleal.cling.support.model.item.Item, org.seamless.xml.SAXParser.Handler)}
...
public class DIDLParser extends SAXParser {
    ...
    public DIDLContent parse(String xml) throws Exception {
    	...
    	try {
            ...
            Utils.print(TAG,"Parsing DIDL XML content");
    ...
    protected Container createContainer(Attributes attributes) {
        ...
        if ((attributes.getValue("childCount") != null))
        	Utils.print("------>", attributes.getValue("childCount"));
    ...
    protected Res createResource(Attributes attributes) {
        ...
        try {
        	if(!attributes.getValue("protocolInfo").equals(""))
        	{
                res.setProtocolInfo(
    ...
    protected void generateContainer(Container container, Document descriptor, Element parent, boolean nestedItems) {
    	...
    	Utils.print("title", container.getTitle());
     ...
     * {@link #createDescMetaHandler(org.teleal.cling.support.model.DescMeta, org.seamless.xml.SAXParser.Handler)},
     ...
     * {@link org.teleal.cling.support.model.DIDLContent#DESC_WRAPPER_NAMESPACE_URI}.
     * </p>
     */
