...
public abstract class Browse extends ActionCallback {
	...
	public void success(ActionInvocation invocation) {
		Utils.print("browse ","Successful browse action, reading output argument values");
		
//		Utils.print("aa", invocation.getOutput("Result").getValue().toString());
		try {
...
//				Utils.print("result", result.getResult());
//				 Utils.setStringContentToFile("/mnt/sdcard/test.txt",
//				 result.getResult());
