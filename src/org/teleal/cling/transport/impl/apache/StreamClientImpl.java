...
public class StreamClientImpl implements StreamClient<StreamClientConfigurationImpl> {
    ...
    final private static String TAG  = "StreamClientImpl";
    ...
    public StreamClientImpl(StreamClientConfigurationImpl configuration) throws InitializationException {
        ...
        HttpConnectionParams.setConnectionTimeout(globalParams, getConfiguration().getConnectionTimeoutSeconds() * 3000);
        HttpConnectionParams.setSoTimeout(globalParams, getConfiguration().getDataReadTimeoutSeconds() * 3000);
