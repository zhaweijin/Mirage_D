...
public class ReceivingAction extends ReceivingSync<StreamRequestMessage, StreamResponseMessage> {
    ...
    private String TAG = "ReceivingAction";
    //log.fine(
    //log.fine(
...
//        Utils.print(TAG, "&&&&&&&&&&&");
        ...
        log.fine(  getInputMessage().getUri()+"");
        ...
        try {
            ...
            log.fine( "Created incoming action request message: " + requestMessage);
        	...
        	log.fine( "Error executing local action: " + ex);        	
