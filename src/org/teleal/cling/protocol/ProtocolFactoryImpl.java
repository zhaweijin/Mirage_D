...
public class ProtocolFactoryImpl implements ProtocolFactory {
    ...
    private String TAG = "ProtocolFactoryImpl";
    protected final UpnpService upnpService;

    public ProtocolFactoryImpl(UpnpService upnpService) {
//        Utils.print(TAG,"Creating ProtocolFactory: " + getClass().getName());
...
//        Utils.print(TAG,"Creating protocol for incoming asynchronous: " + message);
...
//            Utils.print(TAG,"Not a named service type header value: " + usnHeader);
        }
//        Utils.print(TAG,"Service advertisement not supported, dropping it: " + usnHeader);
        return false;
    }

    public ReceivingSync createReceivingSync(StreamRequestMessage message) throws ProtocolCreationException {
//        Utils.print(TAG,"Creating protocol for incoming synchronous: " + message);
